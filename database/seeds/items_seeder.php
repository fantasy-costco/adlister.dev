...
$items=[1 => ['name' =>'Stones of Far Speech','price' => 50,'description' => 'Plain looking stones that allow walkie-talkie-like communication with other stones of far speech. Basically like walkie talkies, but magic','img_path' => '/img/1.png','keywords' =>'communication,non-combat','category'=>'Misc'],
  2 =>['name' =>'Phantom Fist','price' => 400,'description' =>'A glove made of spider silk. Makes your unarmed attacks a little bit stronger.Allows you to knock enemies back with unarmed blows','img_path'=>'/img/2.png','keywords' =>'combat, weapon, equipment,hand slot','category'=>'Equipment'],
  3 =>['name' => 'Xtreme Teen Bible','price' => 75,'description' =>'A +1 holy symbol whose cover features a rad skateboarder. Can more easily spread the good word to teens.','img_path' =>'/img/3.png',
      'keywords' =>'cleric,holy,holy symbol,equipment,non-combat','category'=>'Equipment'],
  4 =>['name' =>'Ring of Pointing','price' => 25,'description' =>'Copper ring with an inlaid ruby that can shoot a laser out. Can be used as a distraction or highlight salient information during a buisiness meeting','img_path' =>'/img/4.png','keywords' => 'non-combat,ring,hand slot,equipment','category'=>'Equipment'],
  5 => ['name' =>'Unlimited Pasta Pass','price' =>100,'description' =>'Can be used at any participating fantasy Olive Garden for free unlimited pasta for the owner and free unlimited soft drinks for the guests',
      'img_path' => '/img/5.png','keywords' =>'non-combat,food','category'=>'Misc'],
  6 => ['name' =>'Wand of Switcharoo','price' =>300,
      ...
      'keywords' => 'magic,combat,hand slot,equipment,wizard,want','category'=>'Weapon'],
  7 => ['name' =>'Scuttle buddy','price' => 150,'description' => 'Mechanical beetle that you can use as a spy. It can talk to you, but it won’t have anything interesting to say beyond its primary functions. Can only be wound up four times before it breaks.',
      'img_path' => '/img/7.png','keywords' =>'non-combat,communication,beetle','category'=>'Misc'],
  8 => ['name' =>'Tankard of Potent Drink','price' => 100,
      'description' =>'A big tankard with pictures of spudz  on it. Makes alcoholic beverages more alcoholic. Drinking water from this tankard makes you instantly sober; if sober it can cure a hangover.','img_path' =>'/img/8.png','keywords' => 'non-combat,food,consumable','category'=>'Misc'],
  9 => ['name' =>'Glasses of Lightning Comprehension','price' => 100, 'description' =>'A set of glasses with a whole bunch of lenses on them.Allows you to read and understand any language you know ten times as fast.',
      'img_path' => '/img/9.png','keywords' =>'non-combat,magic,equipment,head slot','category'=>'Equipment'],
  10 => ['name' => "Lens of Straight Creepin’",'price' => 100,'description' =>'Glasses that make it look like your eyes are closed. Allows you to find footprints, tracks, or markings of anything that traveled through the air once per day.','img_path' =>'/img/10.png',
      'keywords' =>'non-combat,magic, equipment, head slot','category'=>'Equipment'],
  ...
  13 => ['name' => 'Pocket Spa','price' => 900,'description' =>'A bag that when opened magically becomes a small spa. Regain extra hit points whenever you take a short rest.','img_path' => '/img/13.png','keywords' => 'non-combat,magic','category'=>'Misc'],
  14 => ['name' => 'Rusted Can of Cheerwine','price' => 400,
      ...
      'img_path' => '/img/14.png','keywords' =>'magic,food,consumable,non-combat','category'=>'Consumable'],
  15 => ['name' =>"Virtuoso’s Mask",'price' => 1100,'description' =>'Allows you to cast Disguse Self as a Cantrip instead of a 1st Level Spell.','img_path' => '/img/15.png','keywords' => 'magic,non-combat,wizard,rogue,head slot','category'=>'Equipment'],
  ...
  17 => ['name' =>'Alchemist’s Ring','price' => 500,'description' => 'When the wearer of this ring imbibes a healing potion, they receive 1d6 additional healing.','img_path' => '/img/17.png','keywords' => 'magic,ring,hand slot,non-combat,healing','category'=>'Equipment'],
  ...
  21 => ['name' => 'The Anti Gravity Sphere','price' => 500,'description' => 'A small fist-sized glass ball filled with a silvery smoke. When the sphere is destroyed, it disables the effect of gravity on everything in a 30ft radius.','img_path' => '/img/21.png','keywords' => 'magic,non-combat,consumable','category'=>'Consumable'],
  22 => ['name' =>'The Glutton’s Fork','price' => 750, 'description' => 'Once a day this fork will allow the user to eat any non-magical item they can fit in their mouth and gain 2d6 points of health. Just tap the fork on the item and it will turn edible.','img_path' => '/img/22.png','keywords' =>'magic,non-combat,healing','category'=>'Misc'],
  23 => ['name' => 'The Champion’s Belt','price' => 800,'description' => 'This ornate belt is given to someone who has bested all opponents in a test of strength.  Once per day the wearer may substitute their Strength score for their Wisdom or Charisma when making a stat check.','img_path' => '/img/23.png','keywords' => 'magic,non-combat,waist item','category'=>'Equipment'],
  24 => ['name' => 'Phone a friend scrying bones','price' => 500,'description' => 'Once per day, can be used to ask a yes, no, or maybe question to the fates (DM). There are three bones carved into people with happy faces and sad faces. All happy faces means yes, all sad faces mean no, anything in between means maybe. The DM can respond or choose not to answer.','img_path' => '/img/24.png','keywords' =>'magic,non-combat,communication','category'=>'Equipment'],
  25 => ['name' => 'The Nit Picker','price' => 900,'description' => "Resembles a miniature garden gnome that carries lock picking tools in his hands. When not in use, looks like a 4" . '"' . "tall statue.</p><p>Twice daily, can be placed in front of a locked object to unlock it (functions as the spell 'Knock'). At this point, the statue comes to life in order to pick the lock. After the lock is picked (or if he is unable to open it), reverts back to an inanimate statue.\nWhile picking the lock, the Nit Picker critiques any or all members of the party on their recent performance in the campaign. Nothing escapes the critical eye of the Nit Picker, no matter how small the perceived offense.",'img_path' => '/img/25.png','keywords' => 'magic,non-combat','category'=>'Tool'],
  26 => ['name' => 'Plastic Sheriff Badge','price' =>500,'description' => 'Adds +3 to bluff checks when impersonating a person of authority.','img_path' => '/img/26.png','keywords' => 'magic,non-combat','category'=>'Equipment'],
  27 => ['name' => 'Flaming Poisoning Raging Sword of Doom',
      'price' => 60000,'description' =>'A sword with a gigantic blade, wreathed in flames and with a crooked, oozing scorpion’s stinger affixed to its point. Deals an extra 20 melee damage.','img_path' => '/img/27.png','keywords' => 'combat,hand slot,weapon','category'=>'Weapon'],
  28 => ['name' => 'No-Sodium Salt Shaker','price' => 400,'description' =>'A simple salt shaker, the contents of which have been bewitched to turn a bright shade of pink if sprinkled over food or drink that contains poison.','img_path' => '/img/28.png','keywords' => 'magic,non-combat','category'=>'Misc'],
  29 => ['name' => 'The Immovable Rod','price' => 1100,'description' => 'This rod is a flat iron bar with a small button on one end. When the button is pushed (a move action), the rod does not move from where it is, even if staying in place defies gravity. Thus, the owner can lift or place the rod wherever he wishes, push the button, and let go. Several immovable rods can even make a ladder when used together (although only two are needed). An immovable rod can support up to 8,000 pounds before falling to the ground. If a creature pushes against an immovable rod, it must make a DC 30 Strength check to move the rod up to 10 feet in a single round.','img_path' => '/img/29.png','keywords' => 'magic,non-combat','category'=>'Tool'],
  30 => ['name' => 'Diadem of Fabulous Truthiness!','price' => 900,'description' => 'Once per long rest, you can channel your terminal fabulousity into this simple circlet and cast a free Zone of Truth, limited to a single target rather than a radius. Confound your enemies, emasculate your friends, and free up your cleric’s spell slots so he can do some actual healing.','img_path' =>'/img/30.png','keywords' =>'magic,non-combat,cleric','category'=>'Equipment']];

$insert=$dbc->prepare("INSERT INTO items (item_name,item_price,img_path,item_description,keywords,category) VALUES (:name,:price,:img_path,:description,:keywords,:category)");
