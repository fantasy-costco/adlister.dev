...
$items=[1 => ['name' =>'Stones of Far Speech','price' => 50,'description' => 'Plain looking stones that allow walkie-talkie-like communication with other stones of far speech. Basically like walkie talkies, but magic','img_path' => '/img/1.png','keywords' =>'communication,','category'=>'Misc'],
  ...
  28 => ['name' => 'No-Sodium Salt Shaker','price' => 400,'description' =>'A simple salt shaker, the contents of which have been bewitched to turn a bright shade of pink if sprinkled over food or drink that contains poison.','img_path' => '/img/28.png','keywords' => 'magic,','category'=>'Misc'],
  29 => ['name' => 'The Immovable Rod','price' => 1100,'description' => 'This rod is a flat iron bar with a small button on one end. When the button is pushed (a move action), the rod does not move from where it is, even if staying in place defies gravity. Thus, the owner can lift or place the rod wherever he wishes, push the button, and let go. Several immovable rods can even make a ladder when used together (although only two are needed). An immovable rod can support up to 8,000 pounds before falling to the ground. If a creature pushes against an immovable rod, it must make a DC 30 Strength check to move the rod up to 10 feet in a single round.','img_path' => '/img/29.png','keywords' => 'magic,','category'=>'Tool'],
  30 => ['name' => 'Diadem of Fabulous Truthiness!','price' => 900,'description' => 'Once per long rest, you can channel your terminal fabulousity into this simple circlet and cast a free Zone of Truth, limited to a single target rather than a radius. Confound your enemies, emasculate your friends, and free up your cleric’s spell slots so he can do some actual healing.','img_path' =>'/img/30.png','keywords' =>'magic,cleric','category'=>'Equipment']];
